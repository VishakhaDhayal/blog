                ...
                <div class="col-lg-6">
                    <article class="hentry post post-standard has-post-thumbnail sticky">
                            ...
                            <div class="post-thumb">
                                ...
                                <div class="overlay"></div>
                                <a href="app/img/2.jpg" class="link-image js-zoom-image">
                                    <i class="seoicon-zoom"></i>
                                </a>
                                <a href="#" class="link-post">
                                    <i class="seoicon-link-bold"></i>
                ...
                <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <h4 class="h1 heading-title">{{$painting->name}}</h4>
                    ...
                    <div class="row">
                        ...
                        @foreach($painting->post()->orderBy('created_at','desc')->take(3)->get() as $posts)
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="case-item">
                                    <div class="case-item__thumb">
                                        <img src="{{$posts->featured}}" alt="our case">
                                    </div>
                                    <h6 class="case-item__title"><a href="#">{{$posts->title}}</a></h6>
                                </div>
                            </div>
                        @endforeach
                        </div>
